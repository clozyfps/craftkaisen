...
public class Modelprisonrealmarmornewagain<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "prisonrealmarmornewagain"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(34, 0)
				.addBox(11.2667F, 4.9333F, -11.1333F, 5.7333F, 4.6667F, 4.6667F, new CubeDeformation(0.0F))
				.texOffs(0, 0).addBox(13.9333F, -10.5333F, -8.4667F, 0.0F, 18.0F, 18.5333F, new CubeDeformation(0.0F))
				.texOffs(17, 5)
				.addBox(11.2667F, 4.9333F, 7.5333F, 5.7333F, 4.6667F, 4.6667F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.1333F, 20.8F, 0.0F, 0.0F, 0.0F, -1.5708F));

		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5333F, -24.9333F, 7.0F, 5.7333F, 4.6667F, 4.6667F,
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(0, 38).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm = partdefinition
				.addOrReplaceChild("LeftArm",
						CubeListBuilder.create().texOffs(0, 42).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F,
								new CubeDeformation(0.0F)),
