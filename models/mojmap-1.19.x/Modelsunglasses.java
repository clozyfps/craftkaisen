...
public class Modelsunglasses<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sunglasses"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(0, 3)
						.addBox(-1.8F, -0.8F, 4.01F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
						.addBox(-1.8F, -0.8F, -4.01F, 6.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -4.0F, -2.51F, 1.5708F, -1.3526F, -1.5708F));

		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -0.8F, -1.79F, 8.0F, 2.0F, 0.0F,
