...
public class Modelwood_binds<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "wood_binds"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(-1, -1).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F,
		...
		PartDefinition cube_r19 = Body.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(-1, -1).addBox(-0.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r29 = Body.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(-1, -1).addBox(-0.5F, -0.5F, -1.5F, 2.0F, 1.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r30 = Body.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -1.5F, -0.5F, 3.0F, 2.0F, 2.0F,
						new CubeDeformation(0.0F)),
