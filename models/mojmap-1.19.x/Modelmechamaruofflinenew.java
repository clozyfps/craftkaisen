...
public class Modelmechamaruofflinenew<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mechamaruofflinenew"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition HatLayer_r1 = Head
				.addOrReplaceChild("HatLayer_r1",
						CubeListBuilder.create().texOffs(32, 0).addBox(-4.0F, -28.8F, 5.6F, 8.0F, 8.0F, 8.0F,
								new CubeDeformation(0.5F)),
						PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.48F, 0.0F, 0.0F));

		PartDefinition Head_r1 = Head
				.addOrReplaceChild("Head_r1",
						CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -29.3333F, 4.0F, 8.0F, 8.0F, 8.0F,
		...
		PartDefinition LeftArm_r1 = RightArm.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(32, 48).addBox(-7.7333F, -22.5F, -8.1F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r2 = LeftArm.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(32, 48).addBox(4.0F, -22.5F, -8.1F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 22.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
