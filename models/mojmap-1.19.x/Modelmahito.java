...
public class Modelmahito<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mahito"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0)
						...
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.5F)).texOffs(24, -8)
						.addBox(-4.5F, 0.0F, -4.0F, 0.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(24, -8)
						.mirror().addBox(4.5F, 0.0F, -4.0F, 0.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(0, 33).addBox(-4.0F, 0.0F, 4.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
