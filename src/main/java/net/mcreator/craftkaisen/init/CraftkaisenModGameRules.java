...
public class CraftkaisenModGameRules {
	...
	public static final GameRules.Key<GameRules.BooleanValue> CK_ALLOW_CUSTOM_TECHNIQUES = GameRules.register("ckAllowCustomTechniques", GameRules.Category.UPDATES, GameRules.BooleanValue.create(false));
}
