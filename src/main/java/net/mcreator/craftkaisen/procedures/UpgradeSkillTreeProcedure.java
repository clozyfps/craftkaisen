		...
		if (entity.getPersistentData().getBoolean("DefenseChosen")) {
			if ((entity.getCapability(CraftkaisenModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftkaisenModVariables.PlayerVariables())).SkillPoints >= 2 && entity instanceof ServerPlayer _plr1 && _plr1.level instanceof ServerLevel
					&& _plr1.getAdvancements().getOrStartProgress(_plr1.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:core_skill_tree"))).isDone() && !(entity instanceof ServerPlayer _plr2
							&& _plr2.level instanceof ServerLevel && _plr2.getAdvancements().getOrStartProgress(_plr2.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:deleted_mod_element"))).isDone())) {
				{
				...
				CraftkaisenMod.queueServerWork(10, () -> {
					...
					&& _plr8.level instanceof ServerLevel && _plr8.getAdvancements().getOrStartProgress(_plr8.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:deleted_mod_element"))).isDone()
					&& !(entity instanceof ServerPlayer _plr9 && _plr9.level instanceof ServerLevel
							&& _plr9.getAdvancements().getOrStartProgress(_plr9.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:defense_ii"))).isDone())) {
				{
				...
				CraftkaisenMod.queueServerWork(10, () -> {
					...
					&& !(entity instanceof ServerPlayer _plr16 && _plr16.level instanceof ServerLevel
							&& _plr16.getAdvancements().getOrStartProgress(_plr16.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:deleted_mod_element"))).isDone())) {
				{
				...
				CraftkaisenMod.queueServerWork(10, () -> {
					...
					&& _plr22.level instanceof ServerLevel && _plr22.getAdvancements().getOrStartProgress(_plr22.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:deleted_mod_element"))).isDone()
				...
				CraftkaisenMod.queueServerWork(10, () -> {
					...
					&& !(entity instanceof ServerPlayer _plr30 && _plr30.level instanceof ServerLevel
							&& _plr30.getAdvancements().getOrStartProgress(_plr30.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:deleted_mod_element"))).isDone())) {
				{
				...
				CraftkaisenMod.queueServerWork(10, () -> {
					...
					&& _plr36.getAdvancements().getOrStartProgress(_plr36.server.getAdvancements().getAdvancement(new ResourceLocation("craftkaisen:deleted_mod_element"))).isDone()) {
