...
public class SpecialGradeCurseDeathProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, Entity entity, Entity sourceentity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(CraftkaisenModMobEffects.CURSED_SPIRIT.get()) : false)
				&& (entity instanceof LivingEntity _livEnt && _livEnt.hasEffect(CraftkaisenModMobEffects.CURSED_SPIRIT.get()) ? _livEnt.getEffect(CraftkaisenModMobEffects.CURSED_SPIRIT.get()).getAmplifier() : 0) >= 0) {
