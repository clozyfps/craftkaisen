...
public class PlayfulCloudLivingEntityIsHitWithToolProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (world instanceof ServerLevel _level)
			_level.sendParticles((SimpleParticleType) (CraftkaisenModParticleTypes.IMPACT.get()), x, y, z, 2, 1, 2, 1, 0);
		...
		entity.setDeltaMovement(new Vec3(((-0.6) * entity.getLookAngle().x), (0.05 * entity.getLookAngle().y), ((-0.6) * entity.getLookAngle().z)));
	}
}
