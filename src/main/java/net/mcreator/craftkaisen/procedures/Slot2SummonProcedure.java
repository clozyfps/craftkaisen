...
public class Slot2SummonProcedure {
	public static Entity execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		} else if (((entity.getCapability(CraftkaisenModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new CraftkaisenModVariables.PlayerVariables())).ConsumedSpirit2).equals("Fly Head")) {
			if (world instanceof ServerLevel _level) {
