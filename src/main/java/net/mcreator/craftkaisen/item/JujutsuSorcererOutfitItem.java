...
public abstract class JujutsuSorcererOutfitItem extends ArmorItem {
	public JujutsuSorcererOutfitItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "jujutsu_sorcerer_outfit";
			}
	...
	public static class Chestplate extends JujutsuSorcererOutfitItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "craftkaisen:textures/entities/thomas_vn_jujutsu_kaisen_outfit_v2.png";
		}
	}
