...
import net.mcreator.craftkaisen.procedures.SwitchMovesetPressedProcedure;
...
public class SwitchMovesetMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SwitchMovesetPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		CraftkaisenMod.addNetworkMessage(SwitchMovesetMessage.class, SwitchMovesetMessage::buffer, SwitchMovesetMessage::new, SwitchMovesetMessage::handler);
	}
}
