...
public class Modelesopants<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craftkaisen", "modelesopants"), "main");
	public final ModelPart RightLeg;
	public final ModelPart LeftLeg;

	public Modelesopants(ModelPart root) {
