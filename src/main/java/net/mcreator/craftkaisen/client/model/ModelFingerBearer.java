...
public class ModelFingerBearer<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craftkaisen", "model_finger_bearer"), "main");
	public final ModelPart Body;

	public ModelFingerBearer(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = Body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(30, 11).addBox(-1.5F, -2.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(6.5F, -24.0F, 0.0F));
		...
		PartDefinition right_arm = Body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(30, 11).mirror().addBox(-3.5F, -2.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.5F, -24.0F, 0.0F));
		...
		PartDefinition left_leg = Body.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 28).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -13.0F, 0.0F));
		...
		PartDefinition right_leg = Body.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 28).mirror().addBox(-2.5F, 0.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.0F, -13.0F, 0.0F));
