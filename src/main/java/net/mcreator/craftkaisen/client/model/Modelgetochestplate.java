...
public class Modelgetochestplate<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("craftkaisen", "modelgetochestplate"), "main");
	public final ModelPart Body;
	public final ModelPart LeftArm;
	public final ModelPart RightArm;

	public Modelgetochestplate(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm_r1 = LeftArm.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(26, 26).addBox(-24.15F, -9.0F, -3.0F, 1.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 21.0F, 0.0F, 0.0F, 0.0F, 1.5708F));
		PartDefinition LeftArm_r2 = LeftArm.addOrReplaceChild("LeftArm_r2", CubeListBuilder.create().texOffs(13, 23).addBox(-9.0F, -24.0F, -4.0F, 1.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 21.0F, 6.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition LeftArm_r3 = LeftArm.addOrReplaceChild("LeftArm_r3", CubeListBuilder.create().texOffs(41, 42).addBox(-10.9F, -14.4F, -4.0F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 21.0F, 6.0F, -1.5708F, -1.4399F, 1.5708F));
		PartDefinition LeftArm_r4 = LeftArm.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(19, 8).addBox(-9.0F, -24.0F, -1.0F, 1.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 21.0F, -6.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition LeftArm_r5 = LeftArm.addOrReplaceChild("LeftArm_r5", CubeListBuilder.create().texOffs(27, 42).addBox(-10.9F, -14.4F, -1.0F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 21.0F, -6.0F, 1.5708F, 1.4399F, 1.5708F));
		PartDefinition LeftArm_r6 = LeftArm.addOrReplaceChild("LeftArm_r6", CubeListBuilder.create().texOffs(42, 0).addBox(-9.0F, -24.0F, -2.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 21.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));
		PartDefinition LeftArm_r7 = LeftArm.addOrReplaceChild("LeftArm_r7", CubeListBuilder.create().texOffs(18, 37).addBox(-10.9F, -14.4F, -3.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 21.0F, 0.0F, 3.1416F, 0.0F, 3.0107F));
		PartDefinition LeftArm_r8 = LeftArm.addOrReplaceChild("LeftArm_r8", CubeListBuilder.create().texOffs(4, 37).addBox(-10.9F, -14.4F, -3.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r9 = RightArm.addOrReplaceChild("LeftArm_r9", CubeListBuilder.create().texOffs(26, 26).mirror().addBox(23.15F, -9.0F, -3.0F, 1.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.0F, 21.0F, 0.0F, 0.0F, 0.0F, -1.5708F));
		PartDefinition LeftArm_r10 = RightArm.addOrReplaceChild("LeftArm_r10", CubeListBuilder.create().texOffs(13, 23).mirror().addBox(8.0F, -24.0F, -4.0F, 1.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 21.0F, 6.0F, 0.0F, 1.5708F, 0.0F));
		PartDefinition LeftArm_r11 = RightArm.addOrReplaceChild("LeftArm_r11", CubeListBuilder.create().texOffs(41, 42).mirror().addBox(9.9F, -14.4F, -4.0F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 21.0F, 6.0F, -1.5708F, 1.4399F, -1.5708F));
		PartDefinition LeftArm_r12 = RightArm.addOrReplaceChild("LeftArm_r12", CubeListBuilder.create().texOffs(19, 8).mirror().addBox(8.0F, -24.0F, -1.0F, 1.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 21.0F, -6.0F, 0.0F, -1.5708F, 0.0F));
		PartDefinition LeftArm_r13 = RightArm.addOrReplaceChild("LeftArm_r13", CubeListBuilder.create().texOffs(27, 42).mirror().addBox(9.9F, -14.4F, -1.0F, 1.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(0.0F, 21.0F, -6.0F, 1.5708F, -1.4399F, -1.5708F));
		PartDefinition LeftArm_r14 = RightArm.addOrReplaceChild("LeftArm_r14", CubeListBuilder.create().texOffs(42, 0).mirror().addBox(8.0F, -24.0F, -2.0F, 1.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.0F, 21.0F, 0.0F, -3.1416F, 0.0F, -3.1416F));
		PartDefinition LeftArm_r15 = RightArm.addOrReplaceChild("LeftArm_r15", CubeListBuilder.create().texOffs(18, 37).mirror().addBox(9.9F, -14.4F, -3.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(5.0F, 21.0F, 0.0F, 3.1416F, 0.0F, -3.0107F));
		PartDefinition LeftArm_r16 = RightArm.addOrReplaceChild("LeftArm_r16", CubeListBuilder.create().texOffs(4, 37).mirror().addBox(9.9F, -14.4F, -3.0F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false),
				PartPose.offsetAndRotation(-8.0F, 21.0F, 0.0F, 0.0F, 0.0F, -0.1309F));
