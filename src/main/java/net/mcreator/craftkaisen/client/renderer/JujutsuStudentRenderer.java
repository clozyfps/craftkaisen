...
public class JujutsuStudentRenderer extends HumanoidMobRenderer<JujutsuStudentEntity, HumanoidModel<JujutsuStudentEntity>> {
	public JujutsuStudentRenderer(EntityRendererProvider.Context context) {
