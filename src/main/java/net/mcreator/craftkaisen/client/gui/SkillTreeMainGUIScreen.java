...
public class SkillTreeMainGUIScreen extends AbstractContainerScreen<SkillTreeMainGUIMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		DisplayDefenseICheckProcedure.execute(entity)
		...
		DisplayDefenseIICheckProcedure.execute(entity)
		...
		DisplayDefenseIIICheckProcedure.execute(entity)
		...
		DisplayDefenseIVCheckProcedure.execute(entity)
		...
		DisplayDefenseVCheckProcedure.execute(entity)
		...
		DisplayPowerICheckProcedure.execute(entity)
		...
		DisplayPowerIICheckProcedure.execute(entity)
		...
		DisplayPowerIIICheckProcedure.execute(entity)
		...
		DisplayPowerIVCheckProcedure.execute(entity)
		...
		DisplayPowerVCheckProcedure.execute(entity)
		...
		DisplayCursedEnergyICheckProcedure.execute(entity)
		...
		DisplayCursedEnergyIICheckProcedure.execute(entity)
		...
		DisplayCursedEnergyIIICheckProcedure.execute(entity)
		...
		DisplayCursedEnergyIVCheckProcedure.execute(entity)
		...
		DisplayCursedEnergyVCheckProcedure.execute(entity)
		...
		DisplayAgilityICheckProcedure.execute(entity)
		...
		DisplayAgilityIICheckProcedure.execute(entity)
		...
		DisplayAgilityIIICheckProcedure.execute(entity)
		...
		DisplayAgilityIVCheckProcedure.execute(entity)
		...
		DisplayAgilityVCheckProcedure.execute(entity)
