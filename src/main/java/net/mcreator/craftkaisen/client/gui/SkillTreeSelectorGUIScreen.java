...
public class SkillTreeSelectorGUIScreen extends AbstractContainerScreen<SkillTreeSelectorGUIMenu> {
	private final static HashMap<String, Object> guistate = SkillTreeSelectorGUIMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_strength;
	Button button_durability;
	Button button_cursed_energy;
	Button button_technique;
	Button button_back;

	public SkillTreeSelectorGUIScreen(SkillTreeSelectorGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("craftkaisen:textures/screens/skill_tree_selector_gui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skill_tree_selector_gui.label_skill_trees"), 55, 10, -12829636);
	}
	...
	public void init() {
		...
		button_back = new Button(this.leftPos + 62, this.topPos + 136, 46, 20, Component.translatable("gui.craftkaisen.skill_tree_selector_gui.button_back"), e -> {
		});
