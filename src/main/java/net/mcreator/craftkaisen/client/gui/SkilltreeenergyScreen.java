...
public class SkilltreeenergyScreen extends AbstractContainerScreen<SkilltreeenergyMenu> {

	private final static HashMap<String, Object> guistate = SkilltreeenergyMenu.guistate;
	...
	public SkilltreeenergyScreen(SkilltreeenergyMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreeenergy.label_name"), -50, 3, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreeenergy.label_stats"), -50, 31, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreeenergy.label_technique"), -61, 56, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreeenergy.label_balls"), -51, 79, -1);
	}
