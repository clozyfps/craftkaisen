...
public class SkilltreepowerScreen extends AbstractContainerScreen<SkilltreepowerMenu> {
	private final static HashMap<String, Object> guistate = SkilltreepowerMenu.guistate;
	...
	public SkilltreepowerScreen(SkilltreepowerMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreepower.label_name"), -50, 3, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreepower.label_stats"), -50, 31, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreepower.label_technique"), -61, 56, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreepower.label_balls"), -51, 79, -1);
	}
