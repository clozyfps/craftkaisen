...
import net.mcreator.craftkaisen.network.DesignGUIButtonMessage;
...
public class DesignGUIScreen extends AbstractContainerScreen<DesignGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		if (ErrorDisplayProcedure.execute(entity))
			this.font.draw(poseStack,
					...
					DIsplayErrorProcedure.execute(entity), 284, 277, -65536);
	}
	...
	public void init() {
		...
		button_confirm = new Button(this.leftPos + 406, this.topPos + 239, 61, 20, Component.translatable("gui.craftkaisen.design_gui.button_confirm"), e -> {
			if (true) {
				CraftkaisenMod.PACKET_HANDLER.sendToServer(new DesignGUIButtonMessage(0, x, y, z));
				DesignGUIButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		});
