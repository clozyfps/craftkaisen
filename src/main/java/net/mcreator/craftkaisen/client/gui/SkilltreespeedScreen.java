...
public class SkilltreespeedScreen extends AbstractContainerScreen<SkilltreespeedMenu> {
	private final static HashMap<String, Object> guistate = SkilltreespeedMenu.guistate;
	...
	public SkilltreespeedScreen(SkilltreespeedMenu container, Inventory inventory, Component text) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreespeed.label_name"), -50, 3, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreespeed.label_stats"), -50, 31, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreespeed.label_technique"), -61, 56, -1);
		this.font.draw(poseStack, Component.translatable("gui.craftkaisen.skilltreespeed.label_balls"), -51, 79, -1);
	}
