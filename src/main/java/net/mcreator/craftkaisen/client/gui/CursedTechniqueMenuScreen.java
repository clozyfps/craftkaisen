...
import net.mcreator.craftkaisen.procedures.DisplaymovebuttonProcedure;
import net.mcreator.craftkaisen.network.CursedTechniqueMenuButtonMessage;
...
public class CursedTechniqueMenuScreen extends AbstractContainerScreen<CursedTechniqueMenuMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack,
				...
				ReturnTechniqueProcedure.execute(entity), 51, 7, -12829636);
		this.font.draw(poseStack,

				ReturnMoveCostProcedure.execute(entity), 6, 133, -12829636);
		this.font.draw(poseStack,
	...
	public void init() {
		...
		button_unlock = new Button(this.leftPos + 105, this.topPos + 133, 56, 20, Component.translatable("gui.craftkaisen.cursed_technique_menu.button_unlock"), e -> {
			if (DisplaymovebuttonProcedure.execute(entity)) {
