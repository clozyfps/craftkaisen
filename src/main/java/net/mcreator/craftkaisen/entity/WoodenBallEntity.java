...
import net.mcreator.craftkaisen.procedures.WoodenBallWhileProjectileFlyingTickProcedure;
import net.mcreator.craftkaisen.procedures.WoodenBallProjectileHitsLivingEntityProcedure;
import net.mcreator.craftkaisen.procedures.WoodenBallProjectileHitsBlockProcedure;
...
public class WoodenBallEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitBlock(BlockHitResult blockHitResult) {
		...
		WoodenBallProjectileHitsBlockProcedure.execute(this.level, blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}

	@Override
	public void tick() {
		super.tick();
		WoodenBallWhileProjectileFlyingTickProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
		if (this.inGround)
			this.discard();
	}
