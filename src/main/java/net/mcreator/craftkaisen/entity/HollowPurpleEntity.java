...
public class HollowPurpleEntity extends AbstractArrow implements ItemSupplier {
	public HollowPurpleEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(CraftkaisenModEntities.HOLLOW_PURPLE.get(), world);
	}
	...
	public void tick() {
		super.tick();
		HollowPurpleWhileProjectileFlyingTickProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this.getOwner(), this);
		if (this.inGround)
			this.discard();
	}
	...
	public static HollowPurpleEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		HollowPurpleEntity entityarrow = new HollowPurpleEntity(CraftkaisenModEntities.HOLLOW_PURPLE.get(), entity, world);
	...
	public static HollowPurpleEntity shoot(LivingEntity entity, LivingEntity target) {
		HollowPurpleEntity entityarrow = new HollowPurpleEntity(CraftkaisenModEntities.HOLLOW_PURPLE.get(), entity, entity.level);
