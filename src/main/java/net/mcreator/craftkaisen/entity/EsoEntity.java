...
public class EsoEntity extends Monster {
	...
	public EsoEntity(EntityType<EsoEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(CraftkaisenModItems.DELETED_MOD_ELEMENT_CHESTPLATE.get()));
		this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(CraftkaisenModItems.DELETED_MOD_ELEMENT_LEGGINGS.get()));
