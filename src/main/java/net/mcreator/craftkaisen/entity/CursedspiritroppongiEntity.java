...
public class CursedspiritroppongiEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, ItadoriEntity.class, true, true));
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, MegumiFushiguroEntity.class, true, true));
