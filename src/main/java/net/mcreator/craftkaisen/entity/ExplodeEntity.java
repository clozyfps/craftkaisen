...
import net.mcreator.craftkaisen.procedures.ExplodeProjectileHitsLivingEntityProcedure;
...
public class ExplodeEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		ExplodeProjectileHitsLivingEntityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity());
	}
