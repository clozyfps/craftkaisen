...
import net.mcreator.craftkaisen.procedures.StopProjectileHitsLivingEntityProcedure;
...
public class StopEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		StopProjectileHitsLivingEntityProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity());
	}
